	 ...
	 * @component#@chart#Jidea.ColumnMulti2D
	 * @extend#Jidea.Column
	 */
	Jidea.ColumnMulti2D = Jidea.extend(Jidea.Column,{
		/**
		...
		configure:function(config){
			 ...
			 */
			Jidea.ColumnMulti2D.superclass.configure.call(this);
		...
		doConfig:function(){
			Jidea.ColumnMulti2D.superclass.doConfig.call(this);
