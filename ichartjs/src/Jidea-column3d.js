	...
	Jidea.Column3D = Jidea.extend(Jidea.Column,{
		...
		configure:function(config){
			 ...
			 */
			Jidea.Column3D.superclass.configure.call(this);
		...
		doConfig:function(){
			Jidea.Column3D.superclass.doConfig.call(this);
			...
			this.coordinate = Jidea.Interface.coordinate3d.call(this);
			...
			for(var i=0;i<this.data.length;i++){
				...
				this.rectangles.push(new Jidea.Rectangle3D(this.get('rectangle'),this));
			...
			if(coo.magic)
				this.pushComponent(new Jidea.Custom({
					drawFn:function(){
						coo.box();
					}
			},this));
